...
export default function Footer() {
	return (
		<footer className="flex items-center justify-center h-48 py-2 bg-emerald-400 text-emerald-800 pb-safe-bottom">
			
			<PageWrapper className="flex flex-col items-center justify-center space-y-2">
			<div className="mb-2 text-sm text-center text-emerald-600">
